(function () {
    ...
    function setup() {
        ...
        lives = 5;
        words = ["hydrogen","helium","lithium","beryllium","boron","carbon","nitrogen","oxygen","flourine","neon","sodium","magnesium","aluminium","silicon","phosphorus","sulfur","chlorine","argon","potassium","calcium"];
        messages = {
            win: 'You win!',
            lose: 'Game over!',
        ...
        hint.innerHTML='<h4>Hint : Atomic number : '+(words.indexOf(currentWord)+1)+'</h4>'
        var letter, i;
